...
export function BranchSwapSheet({
  requisitionId,
  currentBranchId,
  currentBranchName,
  open,
  ...
  const change = useChangeBranch(requisitionId);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setError(e instanceof Error ? e.message : "Failed to change branch");
      ...
      >
        ...
        >
          ...
          <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
            <Text style={{ fontSize: 18, fontWeight: "700", color: "#0f172a" }}>Change branch</Text>
