// bom-mobile/src/features/sales/pickers/FgCreateModal.tsx
...
export function FgCreateModal({ visible, onCreated, onClose }: Props) {
    ...
    <Modal visible={visible} animationType="slide" onRequestClose={onClose}>
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : undefined}>
        <View style={{ flexDirection: "row", padding: 16, borderBottomWidth: 1, borderColor: "#e5e7eb", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <Text style={{ fontWeight: "600", fontSize: 16 }}>New finished good</Text>
