...
const COLOURS: Record<RequisitionStatus, string> = {
  // V3 statuses:
  Draft: "bg-slate-500/10 text-muted-foreground dark:text-slate-300 ring-slate-500/20",
  ...
  Cancelled: "bg-slate-500/10 text-muted-foreground dark:text-muted-foreground ring-slate-500/20",
