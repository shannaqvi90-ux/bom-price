  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="w-full max-w-md rounded-xl bg-card p-6 shadow-xl">
        <h2 className="text-lg font-semibold text-foreground">Create Finished Good</h2>
        <p className="mt-1 text-xs text-muted-foreground">Code auto-generated (FG-XXXX). Branch: Alain.</p>
